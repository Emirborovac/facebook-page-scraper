...
POLL_INTERVAL = 5
FACEBOOK_SCRAPING_WORKER_COUNT = max(0, int(os.getenv("FACEBOOK_SCRAPING_WORKER_COUNT", "6")))
TIKTOK_SCRAPING_WORKER_COUNT = max(0, int(os.getenv("TIKTOK_SCRAPING_WORKER_COUNT", "3")))
INSTAGRAM_SCRAPING_WORKER_COUNT = max(0, int(os.getenv("INSTAGRAM_SCRAPING_WORKER_COUNT", "3")))
